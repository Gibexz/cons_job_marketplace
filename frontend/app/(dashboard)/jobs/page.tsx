...
// // Your Job model uses `active: boolean` not a status string,
// // so we derive the display status from that field
...
//   // ── Fetch logged-in user's jobs on mount ──────────────────
//   useEffect(() => {
//     async function fetchMyJobs() {
//       try {
//         // API: GET /jobs/my — returns jobs posted by the logged-in user
...
//         <Link
//           href="/jobs/create"
//           className="flex items-center gap-2 rounded-lg bg-[#ff6600] px-4 py-2 text-sm font-bold text-white transition-colors hover:bg-[#e65c00]"
//         >
...
//                           Click <strong className="text-[#ff6600]">Post New Job</strong> to create your first listing.
//                         </p>
//                       </div>
//                     </td>
//                   </tr>
...
export default function JobsPage() {
  ...
  // ── Shared delete button logic — used in both card and table
